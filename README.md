...
Download the latest release ZIP from this repository's **Releases** page (until a 2.01.00 release is cut, build the ASI as described in `BUILDING.md`; the result must hash to the 2.01.00 value listed under [Verified release hashes](#verified-release-hashes)). The GitHub source archive is not the installable mod package.
