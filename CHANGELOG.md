...
- The mod is a single ASI again. A data patch on `gamedata/inventory.pabgb` was carried for one commit while the in-memory route was broken; with the table fixed it is redundant and has been removed.
